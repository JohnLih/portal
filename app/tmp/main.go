...
import (
	...
	_ "portal/app"
	controllers "portal/app/controllers"
...
func main() {
	...
	revel.RegisterController((*controllers.AppController)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "TempleteList",
				Args: []*revel.MethodArg{ 
			...
			&revel.MethodType{
				...
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "name", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "app", Type: reflect.TypeOf((*apps.Application)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
